...
public class KeyStrokeKeyRenderer {
   ...
   public void renderKey(int l, int m, int color) {
      ...
      if (!KeyStroke.customfont) {
         ...
         fr.drawString(p, l + this.c + 8, m + this.d + 8, -16777216 + ((int)((double)q * h) << 16) + ((int)((double)r * h) << 8) + (int)((double)s * h));
         // fr.drawCenteredStringWithShadow(p, l + this.c + 8, m + this.d + 8, -16777216 + ((int)((double)q * h) << 16) + ((int)((double)r * h) << 8) + (int)((double)s * h));
      }
   }
}
