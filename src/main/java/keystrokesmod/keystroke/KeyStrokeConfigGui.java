...
public class KeyStrokeConfigGui extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.buttonList.add(this.CustomFont = new GuiButton(3, this.width / 2 - 70, this.height / 2 + 38, 140, 20, "Custom Font: " + (KeyStroke.outline ? "On" : "Off")));
   }
   ...
   protected void actionPerformed(GuiButton button) {
      ...
      } else if (button == this.CustomFont) {
      KeyStroke.customfont = !KeyStroke.customfont;
      this.outlineBtn.displayString = "Custom Font: " + (KeyStroke.customfont ? "On" : "Off");
   }
