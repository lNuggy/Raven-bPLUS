      ...
      if (e.phase == TickEvent.Phase.END) {
         if (mc.currentScreen == null) {
            if(shouldBridge) {
               ...
               mc.fontRendererObj.drawStringWithShadow(t, (float)x, (float)y, rgb);
               // FontRenderer fr = new FontRenderer(new Font("Inter", 1, 25), true, false);
               // fr.drawStringWithShadow(t, (float)x, (float)y, rgb);
            }
         }
      }
   }
