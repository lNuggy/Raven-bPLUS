...
public class TargetHUD extends Module {
    ...
    public void r(RenderGameOverlayEvent ev) {
        ...
        if (target instanceof EntityLivingBase) {
            ...
            int targetHealth = (int) livingTarget.getHealth();
            fr.drawStringWithShadow(targetName, (int)(width * 0.65), (int)(height * 0.60), 0xffffffff);
            fr.drawStringWithShadow("Health: " + targetHealth, (int)(width * 0.65), (int)(height * 0.65), 0xffffffff);
        }
    }
}