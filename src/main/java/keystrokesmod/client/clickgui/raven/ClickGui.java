...
public class ClickGui extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      if (this.aL != null) {
         animationProgress = this.aL.getValueInt(0, 20, 2);
         this.drawHorizontalLine(halfScreenWidth - 10, halfScreenWidth - 10 + animationProgress, quarterScreenHeight - 29, -1);
         this.drawHorizontalLine(halfScreenWidth + 10, halfScreenWidth + 10 - animationProgress, quarterScreenHeight + 42, -1);
      }
